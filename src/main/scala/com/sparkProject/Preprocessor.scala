...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/Users/mehdiregina/Documents/TP_ParisTech_2017_2018_starter/train.csv")
    ...
    // b) Observer les features catégorielles, comprendre les données, et proposer des cleanings
    //-> incohérences de certaines observations qui n'ont rien à faire la, décalge de colonne ?
    //Features avec peu de variance ?
    ...
    // a) b) c) Modification des features temporelles : une date en soi n'est pas exploitable, des durées le sont
    ...
    // d) Regroupe toute les descriptions textuelles dans une même feature, mais un texte en soi n'est pas exploitable !
    // on pourra ensuite la transformer en utilisant le tf-idf pour les rendre exploitables par l'algo
    ...
    /** WRITING DATAFRAME **/
    //Save document in parquet format
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/mehdiregina/Documents/TP_ParisTech_2017_2018_starter/data/prepared_trainingset")
